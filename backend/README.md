...
## Project Structure
    ...
    ├── tesla_airport_servi_40961  # Django project configurations
...
1. Clone this repo and `cd tesla_airport_servi_40961`
...
2. Clone this repo and `cd tesla_airport_servi_40961`
