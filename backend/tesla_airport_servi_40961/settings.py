"""
Django settings for tesla_airport_servi_40961 project.
...
ROOT_URLCONF = 'tesla_airport_servi_40961.urls'
...
WSGI_APPLICATION = 'tesla_airport_servi_40961.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tesla_airport_servi_40961 API",
    "DESCRIPTION": "API documentation for tesla_airport_servi_40961 App",
    "VERSION": "v1",
}
